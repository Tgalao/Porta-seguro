        ...
        <div className="flex flex-col gap-3 rounded-2xl border border-amber-300 bg-amber-50 p-5 dark:border-amber-800 dark:bg-amber-950/40">
          ...
          <label className="flex max-w-xs flex-col gap-1 text-sm">
            ...
            <input
              ...
              autoComplete="off"
              className="rounded-lg border border-slate-300 px-3 py-2 focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-slate-700 dark:bg-slate-900"
            />
          </label>
